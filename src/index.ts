...
// Función para validar el crédito del cliente usando ExternalID
async function esCreditoCorrecto(
  sessionId: string, 
  externalId: string, 
  importe: number
): Promise<boolean> {
  const payload = {
    ...
    params: {
      ...
      args: [externalId, importe],  // Aquí envías el ExternalID y el importe
      kwargs: {}
    },
    id: 1
  };
